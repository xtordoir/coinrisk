...
var displayData = function(dataUnpacked) {
	//console.log(newTrade.Price)
  var msg = dataUnpacked.Timestamp + "," + dataUnpacked.Type + "," + dataUnpacked.Market + "," + dataUnpacked.ID + "," + dataUnpacked.Price + "," + dataUnpacked.Quantity + "," + dataUnpacked.Total
  console.log(msg)
}
